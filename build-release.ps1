...
foreach ($file in @('MFG-Enabler.exe','MFG-Enabler.deps.json','MFG-Enabler.runtimeconfig.json','Microsoft.ui.xaml.dll','coreclr.dll','hostfxr.dll','Assets/MFG-Enabler.ico')) {
