...
MFG-Enabler manages the sdli1995/dlssg_for_sm86 runtime in supported Windows games. Version 1.2 supports the upstream 0.3.4 source ZIP layout and restores an existing installation before upgrading it.
...
See [the 1.2 release notes](docs/RELEASE-NOTES-1.2.md).
